...
#   $ bew install --HEAD https://raw.githubusercontent.com/scrapinghub/zyte-proxy-headless-proxy/master/zyte-proxy-headless-proxy.rb
#
...
class SmartProxyManagerHeadlessProxy < Formula
  ...
  homepage "https://github.com/scrapinghub/zyte-proxy-headless-proxy"

  revision 0
  url "https://github.com/scrapinghub/zyte-proxy-headless-proxy.git", :using => :git, :tag => "1.2.1"
  head "https://github.com/scrapinghub/zyte-proxy-headless-proxy.git"
